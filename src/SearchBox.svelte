...
<form on:submit|preventDefault="{handleSubmit}">
    <div class="mx-auto relative w-3/4 md:w-1/3 ">
        ...
        <input autocomplete="off" placeholder="Username or UUID" type="search" bind:value={username} class="p-4 bg-white rounded-full border-gray-500 border pl-10 w-full"/>
    </div>
</form>
<style>
input {
